...
const Signincover = () => {
    ...
    return (
        <>
            ...
            <div className='bg-white dark:!bg-bodybg'>
                                ...
                                <div className="p-[3rem]">
                                    <div className="mb-4">
                                        <Link aria-label="anchor" href="/components/dashboards/crm/">
                                            <img src="../../../../assets/images/brand-logos/dospeedoDashboard_logo.jpeg" alt="" className="authentication-brand desktop-logo" />
                                    ...
                                    <div className="btn-list">
                                        ...
                                        <button aria-label="button" type="button" className="ti-btn ti-btn-icon ti-btn-light"><i className="ri-twitter-x-fill"></i></button>
                                    </div>
