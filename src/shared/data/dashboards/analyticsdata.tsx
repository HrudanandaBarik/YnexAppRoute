...
export class Sessionbydevice extends Component<{}, spark3> {
    ...
    render() {
        return (
            <div>
                <ReactApexChart options={this.state.options} series={this.state.series} type="donut" height={237} />
            </div>
...
export class Sessionduration extends Component<{}, spark3> {
    ...
    render() {
        return (
            <div>
                <ReactApexChart options={this.state.options} series={this.state.series} type="line" height={417} />
            </div>
