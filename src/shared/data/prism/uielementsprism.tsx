...
<li className="ti-list-group-item flex justify-between items-center font-semibold"> Groceries
...
export const Styleiconbreadcrumb = `              <ol className="flex items-center whitespace-nowrap min-w-0">
                <li className="text-sm">
                  <Link className="flex items-center text-primary hover:text-primary dark:text-primary" href="#!">
...
export const Style3breadcrumb = ` <ol className="flex items-center whitespace-nowrap min-w-0 pb-2">
                <li className="text-sm">
                  <Link className="flex items-center text-primary hover:text-primary dark:text-primary" href="#!">
                    <svg className="flex-shrink-0 me-3 h-4 w-4 text-primary hover:text-primary dark:text-primary" width="16" height="16"
                      fill="currentColor" viewBox="0 0 16 16">
