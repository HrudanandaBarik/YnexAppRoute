...
<div id="todo-compose" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
    <div className="hs-overlay-open:mt-7 ti-modal-box pointer-events-auto mt-0 ease-out">
...
<div id="staticBackdrop" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none  [--overlay-backdrop:static]">
    <div className="hs-overlay-open:mt-7 ti-modal-box pointer-events-auto mt-0 ease-out">
        <div className="ti-modal-content">
        <div className="ti-modal-header">
...
<div id="exampleModalScrollable" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
    <div className="hs-overlay-open:mt-7  ti-modal-box pointer-events-auto mt-0 ease-out">
        <div className="ti-modal-content">
        <div className="ti-modal-header">
            <h6 className="modal-title text-[1rem] font-semibold">Modal title</h6>
...
<div id="hs-vertically-centered-modal" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
<div className="hs-overlay-open:mt-7 ti-modal-box pointer-events-auto mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
  <div className="ti-modal-content">
    <div className="ti-modal-header">
...
<div id="hs-vertically-centered-scrollable-modal" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
<div className="hs-overlay-open:mt-7 ti-modal-box pointer-events-auto mt-0 ease-out h-[calc(100%-3.5rem)] min-h-[calc(100%-3.5rem)] flex items-center">
...
<div id="exampleModalScrollable4" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
<div className="hs-overlay-open:mt-7 ti-modal-box pointer-events-auto mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
...
<div id="exampleModalgrid" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
<div className="hs-overlay-open:mt-7 ti-modal-box pointer-events-auto mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
  <div className="ti-modal-content w-full">
    <div className="ti-modal-header">
...
<div id="hs-toggle-between-modals-first-modal" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
<div className="hs-overlay-open:mt-7 ti-modal-box pointer-events-auto mt-0 ease-out">
  <div className="ti-modal-content">
    <div className="ti-modal-header">
...
<div id="hs-toggle-between-modals-second-modal" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
<div className="hs-overlay-open:mt-7 ti-modal-box pointer-events-auto mt-0 ease-out">
  <div className="ti-modal-content">
    <div className="ti-modal-header">
      <h6 className="ti-modal-title">
...
<div id="hs-extralarge-modal" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
<div className="hs-overlay-open:mt-7 ti-modal-box pointer-events-auto mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 lg:!mx-auto">
<div className="ti-modal-content">
    <div className="ti-modal-header">
    <h6 className="ti-modal-title">
        Modal title
...
<div id="hs-large-modal" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
<div className="hs-overlay-open:mt-7 ti-modal-box pointer-events-auto mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
<div className="ti-modal-content">
    <div className="ti-modal-header">
    <h6 className="ti-modal-title">
        Modal title
...
<div id="hs-small-modal" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
<div className="hs-overlay-open:mt-7 ti-modal-box pointer-events-auto mt-0 ease-out">
<div className="ti-modal-content">
    <div className="ti-modal-header">
    <h6 className="ti-modal-title">
...
<div id="hs-full-screen-modal" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
<div className="hs-overlay-open:mt-0 ti-modal-box pointer-events-auto mt-10 !m-0 !max-w-full !w-full">
...
<div id="hs-full-screen-modal-below-sm" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
<div className="hs-overlay-open:mt-0 ti-modal-box pointer-events-auto mt-10 max-w-full w-full !m-0 sm:hs-overlay-open:!mt-10 sm:!mt-0 sm:max-w-lg sm:!mx-auto">
...
<div id="hs-full-screen-modal-below-md" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
<div className="hs-overlay-open:mt-0 ti-modal-box pointer-events-auto mt-10 !max-w-full w-full !m-0 md:hs-overlay-open:!mt-10 md:!mt-0 md:!max-w-lg md:!mx-auto">
...
<div id="hs-full-screen-modal-below-lg" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
<div className="hs-overlay-open:mt-0 ti-modal-box pointer-events-auto mt-10 !max-w-full w-full !m-0 lg:hs-overlay-open:!mt-10 lg:!mt-0 lg:!max-w-lg lg:!mx-auto">
...
<div id="hs-full-screen-modal-below-xl" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
<div className="hs-overlay-open:mt-0 ti-modal-box pointer-events-auto mt-10 !max-w-full w-full !m-0  xl:hs-overlay-open:!mt-10 xl:!mt-0 xl:!max-w-xl xl:!mx-auto">
...
<div id="hs-full-screen-modal-below-xxl" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
<div className="hs-overlay-open:mt-0 ti-modal-box pointer-events-auto mt-10 !max-w-full w-full !m-0  xxl:hs-overlay-open:!mt-10 xxl:!mt-0 xxl:!max-w-xl xxl:!mx-auto">
