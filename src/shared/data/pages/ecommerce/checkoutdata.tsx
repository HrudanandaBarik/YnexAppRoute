                    ...
                    <div className="p-6">
                        ...
                        <div className="text-[0.9375rem] font-semibold sm:flex block items-center justify-between mb-4">
                            ...
                            <div className="sm:mt-0 mt-2">
                                ...
                                <div id="modal-new-address" className="hs-overlay ti-modal hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto  hs-overlay-open:opacity-100 hs-overlay-open:duration-500 pointer-events-none">
                                    <div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out pointer-events-auto">
                                                    ...
                                                    <div className="box border dark:border-defaultborder/10 !shadow-none mb-4">
                                                        ...
                                                        <div className="box-body">
                                                            ...
                                                            <div className="grid grid-cols-12 gap-4">
                                                                ...
                                                                <div className="xl:col-span-12 col-span-12">
                                                                    <div className="form-check !flex items-center gap-2 !ps-0">
                                                                        <input className="form-check-input form-checked-success  checked:bg-success checked:ring-success hover:checked:bg-success hover:checked:ring-success focus:checked:bg-success focus:checked:ring-success focus:ring-success focus:border-success" type="checkbox" defaultValue="" id="payment-card-save" defaultChecked />
